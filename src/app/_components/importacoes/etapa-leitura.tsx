...
type EtapaLeituraProps = { sourceProfile: SourceProfile; onAdvance: () => void; onSelectSheet: (sheetName: string) => void; isAnalyzing: boolean; feedbackMessage: string; feedbackMessageKind: "error" | "success" };

export function EtapaLeitura({ sourceProfile, onAdvance, onSelectSheet, isAnalyzing, feedbackMessage, feedbackMessageKind }: EtapaLeituraProps) {
  return <StepScreen eyebrow="ETAPA 2 DE 3" title="Leitura" description="Colunas, qualidade e sugestões de mapeamento.">
    ...
    {isAnalyzing ? <StatusNotice variant="loading">Trocando a aba e atualizando a prévia.</StatusNotice> : null}
